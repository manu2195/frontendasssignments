...
var tableView = {
  ...
  template: function (elementId, elementName, createElementId, textContent) {
              var parent = document.getElementById(elementId);
              var child = document.createElement(elementName);
              if(createElementId != null && createElementId != undefined)
                {child.id= createElementId;}
              if(textContent != null && createElementId != undefined)
